...
const Education = () => {
  ...
  return (
    <div className="relative my-64">
      ...
      <span className="abosulte gradient-04"/>
      ...
      <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
        ...
        <Details
          ...
          <Details
            ...
            info="Completed coursework in advanced topics such 
            as Machine Learning , Design Thinking, Branding and Digital Marketing "
          />
        </ul>
      </div>
    </div>
